...
namespace LibGit2Sharp
{
    ...
    public class Network
    {
        ...
        public virtual IEnumerable<DirectReference> ListReferences(string url)
        {
            ...
            using (RemoteSafeHandle remoteHandle = Proxy.git_remote_create_inmemory(repository.Handle, url, null))
            {
                Proxy.git_remote_connect(remoteHandle, GitDirection.Fetch);
                return Proxy.git_remote_ls(repository, remoteHandle);
            }
        ...
        void doFetch(RemoteSafeHandle remoteHandle, GitRemoteCallbacks gitCallbacks, TagFetchMode? tagFetchMode)
        {
